/*
===============================================================================
This script load data to 'gold' schema which represents the final dimension and fact tables (Star Schema).
...
LEFT JOIN silver.erp_px_cat_g1v2 pc
    ON pn.cat_id = pc.id
WHERE pn.prd_end_dt IS NULL; -- chỉ lấy data về product thời điểm hiện tại
GO
